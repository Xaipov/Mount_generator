...
STEP_INTERVAL     = 20   # каждые N блоков по скелету — чередование block/slab
...
MAX_RADIUS = 21  # Насколько далеко от дороги идет склон (ширина горы)
SLOPE_FACTOR = 0.8 # Насколько пологий склон (0.3 = очень полого, 1.0 = круто)